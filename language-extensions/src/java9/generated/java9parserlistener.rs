...
use super::java9parser::*;

pub trait Java9ParserListener<'input> : ParseTreeListener<'input,Java9ParserContextType>{
/**
...
antlr_rust::coerce_from!{ 'input : Java9ParserListener<'input> }
